...
colorListField.fieldType = "loennProjectManager.expandableColorList"
...
function colorListField.getElement(name, value, options)
    ...
    local fieldWithContext = contextMenu.addContextMenu(
        field,
        function ()
            return expandableGrid.getGrid(gridLs,4,{innerMinWidth=innerMinWidth/2,innerMaxWidth=innerMaxWidth/2},
                function ()
